...
- **Photovoltaic Energy Generation Forecasting in Brazil**  
  Application of machine learning models (decision trees and random forests) for accurate solar generation forecasting with climatic data, achieving a coefficient of determination above 60%. [Link to project on GitHub]
...
- **Off-road Vehicles - Baja SAE**  
  Coordination of the electronics team, embedded systems development with Arduino, and printed circuit board design.
## Contact
...
- Linguagens: Python (avançado), VBA, SQL (básico)
...
- Desenvolvimento de software: Automação de processos, criação de dashboards, análise de dados
...
- **Previsão de geração de energia fotovoltaica no Brasil**  
  Aplicação de modelos de aprendizado de máquina (árvores de decisão e florestas aleatórias) para previsão precisa da geração solar com dados climáticos, resultando em coeficiente de determinação superior a 60%. [Link para o projeto no GitHub]
...
- **Veículos Off-road - Baja SAE**  
  Coordenação da equipe de eletrônica, desenvolvimento de sistemas embarcados com Arduino (algumas das minhas criações estão [aqui]()) e criação de placas de circuito impresso.
## Contato
- 📧 hugo.kersbaumer@gmail.com  
- 🔗 [LinkedIn](https://www.linkedin.com/in/hugo-kersbaumer)  
- 💻 [Portfolio/GitHub](https://github.com/kersbaumerHugo)
